...
const SHELL = [
  ...
  './js/modules/catalog.js','./js/modules/scanner.js','./js/modules/production.js','./js/modules/lab.js','./js/modules/lab-form.js','./js/modules/capa.js','./js/modules/shift.js',
