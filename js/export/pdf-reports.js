...
function exportWeightPDF(){
  ...
  '<tr><td style="border:1px solid #ccc;font-weight:700;background:#f5f5f5;padding:4px 8px;white-space:nowrap">TARGET</td>'+records.map(function(r){var t=recTarget(r);return '<td style="border:1px solid #ccc;text-align:center;font-size:8px">'+(t?t.min+' – '+t.max+' '+unitLabel(recUnit(r)):'not set')+'</td>'}).join('')+'</tr>'+
